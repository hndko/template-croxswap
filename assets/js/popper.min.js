...
!(function (e, t) {
              ...
              (i = (function (e) {
                ...
                (function (e) {
                  var t = e.reduce(function (e, t) {
                    var n = e[t.name];
                    return (e[t.name] = n ? Object.assign(Object.assign(Object.assign({}, n), t), {}, { options: Object.assign(Object.assign({}, n.options), t.options), data: Object.assign(Object.assign({}, n.data), t.data) }) : t), e;
                  }, {});
  ...
  function M(e) {
    ...
    return (
      ...
      c
        ? Object.assign(Object.assign({}, r), {}, (((d = {})[h] = a ? "0" : ""), (d[m] = u ? "0" : ""), (d.transform = 2 > (b.devicePixelRatio || 1) ? "translate(" + e + "px, " + l + "px)" : "translate3d(" + e + "px, " + l + "px, 0)"), d))
  ...
  function L(e, o) {
    if ("viewport" === o) {
      ...
      var l = 0,
        u = 0;
      o && ((p = o.width), (a = o.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((l = o.offsetLeft), (u = o.offsetTop))), (e = k((e = { width: p, height: a, x: l + f(e), y: u })));
  ...
  function H(e, n) {
    ...
    (c = e.rects.popper),
      (a = B(o((p = e.elements[p ? ("popper" === i ? "reference" : "popper") : i])) ? p : p.contextElement || s(e.elements.popper), a, f)),
      (p = j({ reference: (f = t(l)), element: c, strategy: "absolute", placement: n })),
        ...
        fn: function (e) {
          ...
          (e = void 0 === (e = n.gpuAcceleration) || e),
            ...
            null != t.modifiersData.popperOffsets &&
              (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), M(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: n })))),
            null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), M(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
          ...
          if (((e = e.name), !t.modifiersData[e]._skip)) {
            ...
            for (var h = d[0], g = 0; g < d.length; g++) {
              var b = d[g],
                ...
                w = x ? "width" : "height",
                j = H(t, { placement: b, boundary: s, rootBoundary: f, altBoundary: c, padding: a });
              if (
          ...
          if (((s = { x: 0, y: 0 }), l)) {
            if (o) {
              ...
              (b = D[b]),
                ...
                (c = l[p] + c - d),
                (i = Math.max(i ? Math.min(x, h) : x, Math.min(o, i ? Math.max(j, c) : j))),
                (l[p] = i),
                (s[p] = i - o);
            }
  ...
  (e.createPopper = X), (e.defaultModifiers = F), (e.detectOverflow = H), (e.popperGenerator = x), Object.defineProperty(e, "__esModule", { value: !0 });
});
